	...
	<div id="nav">
		<div id="nav_center" class="center">		
			...
			<div id="nav_right" class="divright">
				...
				<ul id="nav_items">
					<a id="first_page"  href="index.jsp"><li class="items curr_item">首&nbsp;&nbsp;&nbsp;&nbsp;页</li></a>
					<a id="check_page"  href="check_ticket.jsp"><li class="items">余票查询</li></a>
					<a id="user_page"  href="personal_info.jsp"><li class="items">个人信息</li></a>
				</ul>
			</div>
		</div>
	</div>
		...
		<div id="input_info" class="divleft common_border info_win">
			...
			<div class="main_area">
				<form name="login_info">
					...
					<input type="button" id="login" class="submit_button" value="登录"/>
					<input type="button" id="register" class="submit_button" value="没有账号？注册一个"/>
				</form>
			</div>
		</div>
		<!--展示信息区域-->
